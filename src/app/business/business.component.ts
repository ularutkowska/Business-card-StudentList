...
@Component({
  ...
  standalone: true,
  imports: [FilterDataPipe,PlDatePipe,MyPipePipe,CommonModule, FormsModule, ShowDateComponent, ManageInterestListComponent, EditInterestDataComponent, StudentPipe],
